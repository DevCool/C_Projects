#!/bin/sh
gcc -m32 -c -g -Os -march=i686 -fno-toplevel-reorder -fomit-frame-pointer -ffreestanding -fdata-sections -ffunction-sections -Wl,--gc-sections -Wall -Werror -I. -o boot.o boot.c
...
gcc -m32 -c -g -Os -march=i686 -fno-toplevel-reorder -fomit-frame-pointer -ffreestanding -fdata-sections -ffunction-sections -Wl,--gc-sections -Wall -Werror -I. -o stage2.o stage2.c
